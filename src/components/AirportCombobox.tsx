  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <button
          type="button"
          className="flex w-full flex-col gap-1 bg-background/60 px-5 py-4 text-left transition-all duration-300 ease-in-out cursor-pointer hover:bg-background/80 focus-within:bg-background"
        >
